...
export class CreateInitialEntites1646498469258 implements MigrationInterface {
    name = 'CreateInitialEntites1646498469258'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "account" ("accountId" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_b1a9fdd281787a66a213f5b725b" PRIMARY KEY ("accountId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("userId" uuid NOT NULL DEFAULT uuid_generate_v4(), "thirdPartyId" character varying, "email" character varying, "phone" character varying, "firstName" character varying, "lastName" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "accountAccountId" uuid, CONSTRAINT "UQ_19de43e9f1842360ce646253d75" UNIQUE ("thirdPartyId"), CONSTRAINT "REL_d6bd30114e883f342b6cb2fb4b" UNIQUE ("accountAccountId"), CONSTRAINT "PK_d72ea127f30e21753c9e229891e" PRIMARY KEY ("userId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_d6bd30114e883f342b6cb2fb4b1" FOREIGN KEY ("accountAccountId") REFERENCES "account"("accountId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_d6bd30114e883f342b6cb2fb4b1"`);
