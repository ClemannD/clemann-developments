...
interface PullToRefreshProps {
    ...
    pulledPastThresholdContent?: JSX.Element | string;
...
const PullToRefreshLib: React.FC<PullToRefreshProps> = ({
    isPullable = true,
    canFetchMore = false,
    onRefresh,
    onFetchMore,
    ...
    const onEnd = (): void => {
        ...
        containerRef.current!.classList.add('ptr--pull-down-loading');
    ...
    return (
        ...
        >
            <div className="ptr__pull-down" ref={pullDownRef}>
                ...
                <div className="ptr__pull-down--pulled-past-threshold">
                    {pulledPastThresholdContent}
                </div>
            </div>
...
export default PullToRefreshLib;
